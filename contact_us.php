...
<div id="page-container" style="margin-top:50px; position: relative;min-height: 84vh;">
  ...
  <div id="content-wrap" style="padding-bottom:50px;">
    ...
    <div class="col-lg-4 mb-4">
        ...
        <br>
        <p>
            <h4>Address : Nanded, Maharastra</h4>
            
        </p>
        <p>
            <h4>Contact Number : 7391853939</h4>
        </p>
        <p>
          <h4>  Email:<a href="https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox"> amittelang7088@gmail.com </a> </h4>
